...
if (!file.exists("data_new/vac/rki_vaccinations.csv")){

  vacc_lk <- fread('https://raw.githubusercontent.com/robert-koch-institut/COVID-19-Impfungen_in_Deutschland/main/Deutschland_Landkreise_COVID-19-Impfungen.csv')
  ...
  fwrite(vacc_lk_tot, here('data_new/vac/rki_vaccinations.csv'))

} else {
  vacc_lk_tot <- fread(here('data_new/vac/rki_vaccinations.csv'))
}



# BTW 2017 ####
if(!file.exists("data_new/elections/btw_2017_es.csv")){
  ...
  fwrite(BTW_17_LK_ES, here('data_new/elections/btw_2017_es.csv'))
} else {
  BTW_17_LK_ES <- fread(here('data_new/elections/btw_2017_es.csv'))
}
...
if (!file.exists("data_new/merged/covid_btw_es.csv")){
  ...
  fwrite(merged_btw, "data_new/merged/covid_btw_es.csv")

} else {
  merged_btw <- fread("data_new/merged/covid_btw_es.csv", encoding = "Latin-1")
}

if(!file.exists("data_new/merged/covid_btw_es_cum.csv")){
...
if(!file.exists("data_new/merged/covid_btw_es_reg.csv")){
